        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('admin.blog_tags')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Blog Tags</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('admin.project_type')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Types</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('admin.siteinfo')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Site Informations</p>
                </a>
              </li>
